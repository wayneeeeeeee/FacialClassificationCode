...
class ResNet50(object):
    def __init__(self, inputs, num_classes=7, is_training=True,
                 scope="resnet50"):
        self.inputs =inputs
...
if __name__ == "__main__":
    ...
    Training_x, Training_y = ferDataPre.raw_data_transform_batch(raw_data_train_csv)
    x_train,y_train = ferDataPre.train_data_shuffle_batch(Training_x,Training_y,BATCH_SIZE)
    resnet50 = ResNet50(x_train)
